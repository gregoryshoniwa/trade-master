...
// TypeScript's lib.dom.d.ts ships SpeechSynthesisUtterance globally, but
// not SpeechRecognition (it's vendor-prefixed and not yet in the spec
// baseline). These declarations are JUST enough for our ChatPanel usage.
